...
export default function VerifyEmail() {
  ...
  const maskEmail = (email) => {
    ...
    const maskedDomain =
      domainName.length <= 1 ? domainName + "***" : domainName[0] + "***";
  ...
  const [seconds, setSeconds] = useState(TESTING_MODE ? 10 : 600);
  ...
  const handleVerify = async (e) => {
    ...
    try {
      const response = await fetch(ApiUrl.VERIFY_EMAIL_PATIENT, {
        method: "POST",
        headers: {
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await fetch(ApiUrl.RESEND_VERIFICATION_PATIENT, {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
                ...
                <div className="patient-verify-card">
                  ...
                  <div className="text-center mt-4">
                    ...
                    <button
                      ...
                      disabled={(!TESTING_MODE && seconds > 0) || resending}
                  ...
                  <div className="text-center">
                    <Link to="/login" className="patient-register-login-link">
                      Back to Login
                    </Link>
                  </div>
                </div>
