...
const requiredDocuments = [
  {
    type: "medical_laboratory_science_degree",
    name: "Bachelor’s Degree in Medical Laboratory Science (MLS)",
  },
  {
  ...
  },
  {
    ...
    name: "Picture of the Principal Owner of the Company",
  },
  {
    type: "company_front_picture",
    name: "Front Pictures of the Company with Signage",
  },
];

export default function LaboratoryDocumentUpload() {
  ...
  const uploadDocuments = async () => {
    ...
    try {
      ...
      const response = await fetch(ApiUrl.UPLOAD_LABORATORY_DOCUMENTS, {
        method: "POST",
  ...
  const loadDocuments = async () => {
    try {
      ...
      const response = await fetch(ApiUrl.GET_LABORATORY_DOCUMENTS, {
        headers: {
          Accept: "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  const deleteDocument = async (id) => {
    ...
    try {
      ...
      const response = await fetch(
        `${ApiUrl.DELETE_LABORATORY_DOCUMENT}/${id}`,
        {
          method: "DELETE",
        ...
        <div className="card-body">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
            <div>
              ...
              <h2 className="page-title">Medical Laboratory Verification</h2>

              <p className="text-muted">
                Upload all required documents for medical laboratory
                verification.
              </p>
            </div>
              ...
              <div className="modal-content">
                <div className="modal-header">
                  <h4 className="modal-title">
                    BADANIX Online Registration for e-Medical Laboratory
                    Scientists
                  </h4>
                ...
                <div className="modal-body">
                  <p>
                    <strong>Dear e-Medical Laboratory Scientist,</strong>
                  </p>

                  <p>
                    Thank you for your interest in registering as an online
                    medical laboratory scientist on BADANIX. To ensure high
                    standards in medical laboratory practice, all applicants
                    must upload the following documents for verification.
                  </p>

                  <p>
                    To practice as a Medical Laboratory Scientist with BADANIX,
                    you must be registered with the Medical Laboratory Science
                    Council or the equivalent regulatory body in your country.
                    You may also need to register your laboratory facility with
                    the appropriate business registration agency in your
                    country, such as:
                  </p>
                  ...
                  <p>
                    ...
                    from the date of submission. Ensure all documents uploaded
                    are clear, legible, and certified to avoid delays.
                  </p>
