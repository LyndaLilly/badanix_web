...
export default function LaboratoryNavbar({ institution, toggleSidebar }) {
  ...
  return (
    <header className="doctor-navbar">
      <div className="doctor-navbar-left">
        ...
        <h4 className="doctor-navbar-title">Laboratory Dashboard</h4>
      </div>
      ...
      <div className="doctor-navbar-right">
        ...
        <div className="doctor-navbar-user">
          <img
            src={imageUrl}
            alt={institution?.institution_name || "Laboratory"}
