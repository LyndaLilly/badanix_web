...
export default function PharmacyNavbar({ institution, toggleSidebar }) {
  ...
  return (
    <header className="doctor-navbar">
      <div className="doctor-navbar-left">
        ...
        <h4 className="doctor-navbar-title">Pharmacy Dashboard</h4>
      </div>
      ...
      <div className="doctor-navbar-right">
        ...
        <div className="doctor-navbar-user">
          <img
            src={imageUrl}
            alt={institution?.institution_name || "Pharmacy"}
