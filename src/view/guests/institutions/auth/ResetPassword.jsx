...
export default function ResetPassword() {
  ...
  const [email] = useState(
    localStorage.getItem("institution_reset_email") || "",
  );

  const [code] = useState(localStorage.getItem("institution_reset_code") || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        ApiUrl.RESET_PASSWORD_INSTITUTION,
      ...
      if (response.ok) {
        ...
        localStorage.removeItem("institution_reset_email");

        localStorage.removeItem("institution_reset_code");
          ...
          <div className="col-lg-5 col-md-7">
            <div className="patient-login-card bg-white p-0 p-md-5 shadow-sm rounded-3">
              ...
              <p className="patient-login-subtitle">
                Create a strong new password for your BADANIX Institution
                account.
              </p>
