  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        ApiUrl.FORGOT_PASSWORD_INSTITUTION,
      ...
      if (response.ok) {
        ...
        navigate("/institution/verify-reset-code");
          ...
          <div className="col-lg-5 col-md-7">
            <div className="patient-login-card bg-white p-0 p-md-5 shadow-sm rounded-3">
              ...
              <p className="patient-login-subtitle">
                Enter your institution email address and we'll send you a
