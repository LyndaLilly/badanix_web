...
export default function InstitutionVerifyEmail() {
  ...
  const email = localStorage.getItem("institution_verify_email") || "";
  ...
  const handlePaste = (e) => {
    ...
    try {
      const response = await fetch(
        ApiUrl.VERIFY_EMAIL_INSTITUTION,
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        localStorage.removeItem("institution_verify_email");
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await fetch(
        ApiUrl.RESEND_VERIFICATION_INSTITUTION,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
              ...
              <div className="patient-verify-image-section">
                ...
                <div className="patient-verify-overlay">
                  <div>
                    ...
                    <p>
                      Secure Digital Healthcare Platform for
