...
import HospitalNavbar from "../view/guests/institutions/loggedin/hospital/partials/Navbar"
import HospitalSidebar from "../view/guests/institutions/loggedin/hospital/partials/Sidebar";
  ...
  useEffect(() => {
    ...
    if (!profileCompleted && !isProfilePage) {
      Swal.fire({
        ...
        text: "Please complete your hospital profile before continuing.",
